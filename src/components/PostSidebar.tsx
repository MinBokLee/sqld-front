...
import { TrendingUp, Heart, Eye, Hash } from 'lucide-react';
    ...
    <aside className="lg:col-span-3 space-y-8">
      <div className="lg:sticky lg:top-8 space-y-8">
        ...
        <div className="bg-white dark:bg-[#1a222c] rounded-3xl p-8 border border-slate-200 dark:border-slate-800 shadow-xl relative overflow-hidden group">
          ...
          <h3 className="text-sm font-black text-slate-900 dark:text-white mb-6 flex items-center gap-2 relative z-10">
