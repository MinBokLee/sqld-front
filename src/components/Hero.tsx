...
export default function Hero({ getText, onOpenSchedule }: HeroProps) {
  ...
  return (
    <section className="mb-10 px-4 py-12 rounded-3xl bg-gradient-to-br from-primary via-blue-500 to-blue-400 text-white shadow-2xl relative overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-10 p-2 md:p-6">
        <div className="flex-1 text-center lg:text-left">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-black mb-6 tracking-tight leading-tight lg:whitespace-nowrap">
            {getText('hero.title')}
          </h1>
